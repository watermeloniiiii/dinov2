...
from dinov2.data import SamplerType, make_data_loader, make_dataset_multimodal
from dinov2.data import collate_data_and_cast, MaskingGenerator, DataAugmentationDINO_MS12
...
def do_train(cfg, model, resume=False):
    ...
    s1_transform = DataAugmentationDINO_MS12(
        cfg.crops.global_crops_scale,
        cfg.crops.local_crops_scale,
        cfg.crops.local_crops_number,
        global_crops_size=cfg.crops.global_crops_size,
        local_crops_size=cfg.crops.local_crops_size,
        mean=SEN12MS_S1_MEAN,
        std=SEN12MS_S1_STD,
        num_channel=cfg.student.in_chans_s1,
    )

    s2_transform = DataAugmentationDINO_MS12(
        cfg.crops.global_crops_scale,
        cfg.crops.local_crops_scale,
        cfg.crops.local_crops_number,
        global_crops_size=cfg.crops.global_crops_size,
        local_crops_size=cfg.crops.local_crops_size,
        mean=SEN12MS_S2_MEAN,
        std=SEN12MS_S2_STD,
        num_channel=cfg.student.in_chans_s2,
    )
    ...
    dataset = make_dataset_multimodal(
