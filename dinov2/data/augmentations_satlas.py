...
from .transforms import GaussianBlur, make_normalize_transform, SENTINEL2_DEFAULT_MEAN, SENTINEL2_DEFAULT_STD


logger = logging.getLogger("dinov2")


class DataAugmentationDINORS(object):
    def __init__(
        self,
        global_crops_scale,
        local_crops_scale,
        ...
        self.normalize = transforms.Compose(
            [
                ...
                make_normalize_transform(
                    mean=SENTINEL2_DEFAULT_MEAN[:num_channel], std=SENTINEL2_DEFAULT_STD[:num_channel]
                ),
            ]
        )
